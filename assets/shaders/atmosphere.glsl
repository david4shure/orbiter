...
layout(set = 1, binding = 0) uniform AtmosphereSettings {
...
// uniforms
layout(set = 1, binding = 1) uniform sampler2D screenTextureSampler; // the original screen texture
layout(set = 1, binding = 2) uniform texture2D screenTexture; // the original screen texture

layout(set = 1, binding = 3) uniform sampler2D depthTextureSampler; // the depth map of the camera
layout(set = 1, binding = 4) uniform texture2D depthTexture; // the depth texture
