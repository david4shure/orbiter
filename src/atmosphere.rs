...
pub(crate) struct PostProcessPlugin;
...
impl ViewNode for PostProcessNode {
    ...
    fn run(
        ...
        (view_target, view_prepass_texture): QueryItem<Self::ViewQuery>,
        world: &World,
    ) -> Result<(), NodeRunError> {
        ...
        let Some(prepass_depth_texture) = &view_prepass_texture.depth else {
            return Ok(());
        };  
